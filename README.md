...
Vendora is a portfolio application that models how a retail operations team would run catalogue, inventory, orders, promotions, and reporting in one product. It is a demonstration storefront. It does not collect payment and is not a live shop.
...
Vendora keeps those concerns in one codebase:
